function varargout = MotorSequenceAppB(varargin)
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @MotorSequenceAppB_OpeningFcn, ...
                   'gui_OutputFcn',  @MotorSequenceAppB_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function MotorSequenceAppB_OpeningFcn(hObject, ~, handles, varargin)
...
function varargout = MotorSequenceAppB_OutputFcn(~, ~, handles) 
...
dirName = '';
while ~strcmp(dirName,'MotorSequence2')
    [currDir,dirName,~] = fileparts(currDir);
end
filepath = fullfile(currDir,'MotorSequence2','Results');
